//Dialogue for nearly everything miscDialogs.hpp
...
class factory_manifacture
{
	...
	objects[] = { };
	controls[] = {list_manifacture, list_needed, manifacture, close, mengeneingabe, dummybutton};
...
class itemkaufdialog
{
	...
	objects[] = { };
	controls[] = {itemliste, itemeingabe, submit, cancel, cancel2, submit2, itemeingabe2, itemliste2, text_inventarmoney, dummybutton};
	class DLG_BACK1: RscBackground
	{
		x = 0.02; y = 0.07;
		w = 0.46; h = 0.63;
