//Small Repair Kit Script, rewritten by MAD T (year 2010) 
 _art = _this select 0;
...
if (not(isNull(_x))) then 
 ...
 if (_i >= 2) then {_closeVcl setDamage (_hp - 0.05); player groupChat localize "STRS_inv_items_repair_repaired"; repkitinuse = 0;};
