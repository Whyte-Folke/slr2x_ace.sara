// Inventar Dialogue for Cops
// 1704550.sqf

if (!(createDialog "inventarCop")) exitWith {hint "Dialog Error!";};
_itemcounter = 0;
...
for [{_c=0}, {_c < (count playerstringarray)}, {_c=_c+1}] do {
	_spieler = playerstringarray select _c;
...
lbSetCurSel [99, 0];
lbSetCurSel [1, 0];
buttonSetAction [3, format["[""use"",  lbData [1, (lbCurSel 1)], ctrlText 501, lbData [99, (lbCurSel 99)]] execVM ""invButtons.sqf""; closedialog 0;"] ];
buttonSetAction [4, format["[""drop"", lbData [1, (lbCurSel 1)], ctrlText 501, lbData [99, (lbCurSel 99)]] execVM ""invButtons.sqf""; closedialog 0;"] ];
buttonSetAction [246, format["[""give"", lbData [1, (lbCurSel 1)], ctrlText 501, lbData [99, (lbCurSel 99)]] execVM ""invButtons.sqf""; closedialog 0;"] ];

// 3 New Cop Buttons (change the script-names pls)
buttonSetAction [18701, "[""use""] execVM ""roadblock.sqf"""];
buttonSetAction [18702, "[""use""] execVM ""impound.sqf"""];
buttonSetAction [18703, "[""use""] execVM ""weaponbag.sqf"""];
