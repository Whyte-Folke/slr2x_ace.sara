...
// Governments Bank account below
class bank_govern
{
	idd = -1;
	movingEnable = true;
	controlsBackground[] = {DLG_BACK1, background};
	objects[] = { };
	controls[] = {text1, spielerliste, text2, transfer_eingabe, submit, cancel, text_accountmoney, dummybutton};
	...
	class background : RscBgRahmen
	{
		x = 0.31; y = 0.14;
		w = 0.37; h = 0.38;
		text = $STRD_bankgov_description_title;
	};
	class text1 : RscText
	{
		x = 0.32; y = 0.17;
		w = 0.35; h = 0.04;
		style = ST_CENTER;
		text = $STRD_bankgov_description_deposit_transfer;
	};
	class spielerliste : RscCombo
	{
		idc = 1;
