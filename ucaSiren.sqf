...
if (_art == "activate") then
{
   ...
   if (_turnOn) then
   {
      format ["[0,0,0,[""client"", %1]] execVM ""ucaSiren.sqf"";", player] call ISSE_pub_execPstr;
   }
   else
   {
