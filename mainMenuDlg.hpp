class MainMenu
{
	...
	objects[] = { };
	controls[] = {button_graphics, button_texts, button_tutorial, button_faq, button_about, button_iteminfo, button_logindialog, button_cancel, dummybutton};
	...
	w = 0.20; h = 0.04;
	text = "Graphics";
	action = "closedialog 0; [""GrafikEinstellungen""] execVM ""openDialogs.sqf"";";
	};
	...
	w = 0.20; h = 0.04;
	text = "Say Texts";
	action = "closedialog 0; [""TextEinstellungen"", ""oeffnen""] execVM ""openDialogs.sqf"";";
	};
	...
	w = 0.20; h = 0.04;
	text = "Tutorial";
	action = "closedialog 0; [""Tutorial""] execVM ""openDialogs.sqf"";";
	};
	...
	w = 0.20; h = 0.04;
	text = "FAQ";
	action = "closedialog 0; [""FAQ""] execVM ""openDialogs.sqf"";";
	};
	...
	w = 0.20; h = 0.04;
	text = "About";
	action = "closedialog 0; [""About""] execVM ""openDialogs.sqf"";";
	};
	...
	w = 0.20; h = 0.04;
	text = "Item info";
	action = "closedialog 0; [""ItemList""] execVM ""openDialogs.sqf"";";
	};
	class button_logindialog : RscButton
	{
	x = 0.40; y = 0.55;
	w = 0.20; h = 0.04;
	text = "Login Dialog";
	action = "closedialog 0; createDialog ""Login_Dialog""";
	};
...
class TextEinstellungenDialog
{
	...
	w = 0.21; h = 0.04;
	text = "Back";
	action = "closedialog 0; [""Einstellungen""] execVM ""openDialogs.sqf"";";
	};
	...
	w = 0.21; h = 0.04;
	text = "Save";
	action = "[""TextEinstellungen"", ""speichern""] execVM ""openDialogs.sqf"";";
	};
